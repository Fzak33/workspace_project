        ...
        <div className="team-main-content">
              ...
              <tbody>
                {filteredMembers.map((member) => (
                  <tr key={member.id}>
                    ...
                    <td>
                      <span
                        className={`department-tag ${member.department.toLowerCase()}`}
                      >
                        {member.department}
                      </span>
                    </td>
                    ...
                    <td>
                      <div className="status-cell">
                        <span
                          className={`status-dot ${member.status.toLowerCase()}`}
                        ></span>
                        {member.status}
                      </div>
                    </td>
          ...
          {isAddModalOpen && (
            <div className="modal-overlay">
              <div
                className={`add-member-modal ${addSuccess ? "success" : ""}`}
              >
                <button
                  className="close-btn"
