...
<button className="view-all-btn-hr" onClick={() => navigate('/hr/time-off')}>View all</button>
                        </div>   
...
<button className="view-all-btn-hr" onClick={() => navigate('/hr/attendance')}>View all</button>
</div>
